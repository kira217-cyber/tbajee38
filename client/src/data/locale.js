...
export const locale = {
  bn: {
    ...
    deskAcc: {
      "suggested": "পরামর্শিত সেটিং",
      "scoreA": "স্কোর হল",
      "scoreB": "পয়েন্ট",
      "loginPw": "লগইন পাসওয়ার্ড",
      "loginPwDesc": "অক্ষর এবং সংখ্যা এর সমন্বয়ে প্রস্তাবিত পাসওয়ার্ড, ছোট হাতের এবং বড় হাতের অক্ষর মিশে আছে।",
      "bindWallet": "ই-ওয়ালেট বাঁধুন",
      "bindWalletDesc": "উত্তোলনের জন্য ই-ওয়ালেট বাঁধুন",
      "payPwDesc": "আপনার পরিচয় যাচাই করতে লেনদেনের পাসওয়ার্ড ব্যবহার করতে হবে অ্যাকাউন্টের নিরাপত্তার উদ্দেশ্যে এবং ফান্ড সংক্রান্ত যেকোনো অপারেশনের জন্য।",
      "logout": "লগআউট",
      "logoutDesc": "নিরাপদে লগআউট করুন",
      "lastTime": "শেষ লগইন সময়",
      "lastIp": "শেষ লগইন আইপি",
      "copied": "কপি হয়েছে",
      "payee": "প্রত্যাহারকারীর নাম",
      "nickname": "ডাকনাম",
      "birthday": "জন্ম তারিখ",
      "email": "ইমেইল",
      "phone": "ফোন নম্বর",
      "ph100": "অনুগ্রহ করে 1 - 100 অক্ষর লিখুন",
      "ph50": "অনুগ্রহ করে 1 - 50 অক্ষর লিখুন",
      "ph255": "অনুগ্রহ করে 1 - 255 অক্ষর লিখুন",
      "ph10": "অনুগ্রহ করে 10 - 11 অক্ষর লিখুন",
      "change": "পরিবর্তন",
      "bind": "বাঁধুন",
      "submit": "জমা দিন",
      "oldPw": "বর্তমান পাসওয়ার্ড",
      "oldTx": "বর্তমান লেনদেন পাসওয়ার্ড",
      "newPw": "নতুন পাসওয়ার্ড",
      "confirmPw": "পাসওয়ার্ড নিশ্চিত করুন",
      "phOldPw": "বর্তমান পাসওয়ার্ড পূরণ করুন",
      "phLoginPw": "লগইন পাসওয়ার্ড পূরণ করুন",
      "phNewPw": "নতুন পাসওয়ার্ড পূরণ করুন",
      "phConfirm": "পাসওয়ার্ড নিশ্চিত করুন পুনরায় লিখুন",
      "walletLabel": "ই-ওয়ালেট",
      "cardName": "কার্ডের নাম",
      "walletType": "ই-ওয়ালেট প্রকার",
      "walletAddr": "ওয়ালেট ঠিকানা",
      "txPw": "লেনদেন পাসওয়ার্ড",
      "phCardName": "প্রাপ্তি কারীর পূর্ণ নাম প্রবেশ করুন",
      "phAddr": "অনুগ্রহ করে {m} অ্যাকাউন্ট নম্বর পূরণ করুন",
      "phTx": "লেনদেন পাসওয়ার্ড লিখুন",
      "registered": "নিবন্ধিত ই-ওয়ালেট",
    ...
    withdrawFlow: {
      ...
      dailyTitle: "আজকের উত্তোলনের সীমা শেষ",
      dailyLine: "দৈনিক উত্তোলন {n} (বার), অবশিষ্ট উত্তোলন {left} (বার)",
      dailyHint: "দিনে সর্বোচ্চ {n} বার উত্তোলন করা যায়। আগামীকাল আবার চেষ্টা করুন।",
      todayLeft: "আজ বাকি উত্তোলনের সংখ্যা:",
      ...
      err: {
        ...
        dailyLimit: "আজকের উত্তোলনের সীমা শেষ",
  ...
  en: {
    ...
    deskAcc: {
      "suggested": "Suggested settings",
      "scoreA": "Score is",
      "scoreB": "points",
      "loginPw": "Login password",
      "loginPwDesc": "A password mixing letters and numbers, upper and lower case, is recommended.",
      "bindWallet": "Bind e-wallet",
      "bindWalletDesc": "Bind an e-wallet for withdrawals",
      "payPwDesc": "The transaction password verifies your identity for account security and every fund operation.",
      "logout": "Logout",
      "logoutDesc": "Log out safely",
      ...
      "email": "Email",
      "phone": "Phone number",
      "ph100": "Please enter 1 - 100 characters",
      "ph50": "Please enter 1 - 50 characters",
      "ph255": "Please enter 1 - 255 characters",
      "ph10": "Please enter 10 - 11 digits",
      "change": "Change",
      "bind": "Bind",
      "submit": "Submit",
      ...
      "phOldPw": "Enter the current password",
      "phLoginPw": "Enter your login password",
      "phNewPw": "Enter the new password",
      "phConfirm": "Enter the password again",
      "walletLabel": "E-wallet",
      "cardName": "Card name",
      "walletType": "E-wallet type",
      "walletAddr": "Wallet address",
      "txPw": "Transaction password",
      "phCardName": "Enter the receiver's full name",
      "phAddr": "Please enter the {m} account number",
      "phTx": "Enter the transaction password",
      "registered": "Registered e-wallets",
    ...
    withdrawFlow: {
      ...
      dailyTitle: "Today's withdraw limit reached",
      dailyLine: "Daily withdrawals {n} (times), {left} left",
      dailyHint: "You can withdraw at most {n} times a day. Please try again tomorrow.",
      todayLeft: "Withdrawals left today:",
      ...
      err: {
        ...
        dailyLimit: "Today's withdraw limit reached",
